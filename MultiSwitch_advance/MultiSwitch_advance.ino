/*
 Version 1.0 - Sept 4, 2021
 Eric Ho
 NOTES:
  - Source: https://github.com/sinricpro/esp8266-esp32-sdk
...
// I am NOT using flip switches
std::map<String, deviceConfig_t> devices = {
    //{deviceId, {relayPIN,  flipSwitchPIN}}
    {"DEVICE-ID-1", {  D1, D8 }},  // Top plug
    {"DEVICE-ID-2", {  D2, D7 }}   // Bottom plug
};
